...
const Settings = () => {
    ...
    return (
        <Layout
            ...
            toggleThemeDialog={toggleThemeDialogue}
        >
            <div className={`flex h-screen  ${theme === 'dark' ? 'bg-[rgb(17,27,33)] text-white' : 'bg-white text-black'}`}>
                <div className={`w-[400px] border-r ${theme === 'dark' ? 'border-gray-600' : 'border-gray-200'}`}>
                    <div className="p-4">
                        ...
                        <input
                            ...
                            className={`w-full ${theme === 'dark' ? 'bg-[#202c33] text-white' : 'bg-gray-100 text-black'}
                ...
                <div className={`h-[calc(100vh-280px)] overflow-y-auto `}>
                    <div className="space y-1">
                        {
                            [
                                ...
                                className={`w-full flex items-center gap-3 p-2 
                                 ${theme==='dark'?'hover:bg-[#202c33] text-white':'text-black hover:bg-gray-100'}`}>
                    ...
                    className={`w-full flex items-center justify-between gap-3 p-3 
                      ${theme==='dark'?'hover:bg-[#202c33] text-white':'text-black hover:bg-gray-100'}`}>
                        {theme==='dark'?(
                         ...
                         <div className={`flex-col text-center text-start border-b ${theme==='dark'?'border-gray-700':'border-gray-200'} w-full p-4`}>
                    ...
                    className={`w-full flex items-center gap-3 p-2 rounded text-red-500  
                     ${theme==='dark'?'hover:bg-[#202c33] text-white':'text-black hover:bg-gray-100'} mt-10 md:mt-36`}>
