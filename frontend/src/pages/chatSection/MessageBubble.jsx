    ...
    return (
        <div className={`chat ${bubbleClass}`}>
            <div className={`${bubbleContent} relative group mt-4`}
                ...
                <div className="self-end flex items-center justify-center gap-1 text-xs opacity-60 mt-2 ml-2">
                    <span>
                ...
                <div className={`absolute ${isUserMessage ? '-left-10' : '-right-10'} top-1/2 transform -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col`}>
                ...
                {
                    showReactions && (
                        <div ref={reactionMenuRef}
                            className={`absolute -top-8 ${isUserMessage ? 'left-0' : 'left-36'} transform -translate-x-1/2 flex items-center bg--[#202c33]/90 rounded-full px-2 py-1.5 gap-1 shadow-lg `}
                        >
                            {
                            ...
                            <div className="w-[1px] h-5 bg-gray-600 mx-1">
                                <button className="bg-[#ffffff1a] rounded-full p-1"
                ...
                {showOptions && (
                    <div ref={optionsRef} className={`absolute top-8 right-1 z-50 w-36 rounded-xl shadow-lg py-2 text-sm ${theme === 'dark' ? 'bg-[#1d1f1f] text-white' : 'bg-gray-100 text-black'} `}>
                        <button
                            onClick={() => {
                        ...
                        {isUserMessage && (
                            ...
                            >
                                <FaRegCopy size={14} className="text-red-600" />
                                <span>Delete</span>
