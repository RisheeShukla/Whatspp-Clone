 ...
 const handleEmojiSelect=(emoji,field)=>{
    ...
    return (
        ...
        >
            ...
            className={`w-full min-h-screen flex border-r ${theme==='dark'?'bg-[rgb(17,27,33)]border-gray-600 text-white':'text-black bg-gray-100 border-gray-200'}`}
            >
                    ...
                    <div className="space-y-6">
                        <div className="flex flex-col items-center">
                            <div className="relative group">
                                ...
                                alt='profile-picture'
                                className="w-52 h-52 rounded-full mb-2 object-cover"/> || <FaCamera  className="w-52 h-52 rounded-full mb-2 object-cover"/>}
                                
                                <label
                                htmlFor="profileUpload"
                                className="absolute inset-0 bg-opacity-50 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer">
                        ...
                        <div className={`relative p-4 ${theme==='dark'?'bg-gray-800':'bg-white'} shadow-sm rounded-lg`}>
                            ...
                            <div className="flex items-center">
                                {isEditingName?(
                                    ...
                                    className={`w-full px-3 py-2 rounded-md border border-gray-200 focus:outline-none focus:ring-2 focus:ring-green-500 ${theme==='dark'?'bg-gray-700 text-white':'bg-white text-black'}`}/>
                                ):(
                                ...
                                )}
                                {
                                    isEditingName?(
                                        ...
                                        className="ml-2 focus:outline-none"
                                        >
                                             <MdCancel className="h-5 w-5 text-green-500"/>
