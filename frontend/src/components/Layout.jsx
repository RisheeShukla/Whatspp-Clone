...
const Layout=({children,isThemeDialogOpen,toggleThemeDialog,isStatusPreview,statusPreviewContent})=>{
 ...
 useEffect(()=>{
    ...
    return (
        <div className={`min-h-screen ${theme==='dark'?"bg-gray-600 text-white":"bg-gray-100 text-black"} flex relative`}>
            { !isMobile && <Sidebar/> }
          <div
          ...
          {isThemeDialogOpen && (
            <div className="fixed inset-0 flex items-center justify-center bg-black  bg-opacity-50 z-50">
                <div className={`${theme==='dark'?'bg-gray-600 text-white':"bg-white text-black"} p-6 rounded-lg shadow-lg max-w-sm w-full`}>
                   ...
                   <div  className="space-y-4">
                    ...
                    className="mt-6 w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-500 transition duration-300 ease-in-out "
